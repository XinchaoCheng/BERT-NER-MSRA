...
def get_args_parser():
    ...
    if os.name == 'nt':
        ...
        bert_path = '/home/share/RMW/BERT-Softmax-NER/download/chinese_L-12_H-768_A-12'
        root_path = '/home/share/RMW/BERT-Softmax-NER'

    group1 = parser.add_argument_group('File Paths',
                                       'config the path, checkpoint and filename of a pretrained/fine-tuned BERT model')
    group1.add_argument('-data_dir', type=str, default=os.path.join(root_path, 'NERdata/msra'),
    ...
    group2.add_argument('-max_seq_length', type=int, default=64,
    ...
    group2.add_argument('-learning_rate', type=float, default=3e-5,
    ...
    group2.add_argument('-device_map', type=str, default='2',
